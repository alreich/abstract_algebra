...
def generate_algebra_from_element_dict(gen_elem_dict, bin_op, elem_eq,
    ...
    (3) elem_eq: a binary operation that returns True if the two elements are equal.
    ...
    table = [[elements.index(rev_elem_dict[nparr_to_tuple(bin_op(elem_dict[a], elem_dict[b]))])
              for b in elem_dict]
             for a in elem_dict]
