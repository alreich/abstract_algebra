...
def generate_powerset_group(n, name=None, description=None):
    """Generate the group on the powerset of a set of size n, where symmetric difference is the operator."""
    if name:
        nm = name
    else:
        nm = "PS" + str(n)
    if description:
        ...
        desc = f"Autogenerated group based on set of {n} elements with symmetric difference operator"
